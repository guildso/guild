...
/* harmony import */ var _joeattardi_emoji_button__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @joeattardi/emoji-button */ "./node_modules/@joeattardi/emoji-button/dist/index.js");
...
document.addEventListener('alpine:init', function () {
  ...
  alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('app', {
    init: function init() {},
    appearance: alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].$persist('auto').as('appearance'),
    appearance_menu: false,
    user_menu_open: false,
    appearanceChange: function appearanceChange(value) {
      if (value == 'light') {
...
window.app = alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].store('app');
Object(hotkeys_js__WEBPACK_IMPORTED_MODULE_1__["default"])('ctrl+return, command+return', function () {
...
window.notification = {
  show: function show(type, message) {
    ...
    var notificationHTML = "<div class=\"w-80 h-auto rounded-t-lg border border-gray-200 border-b-0 dark:border-dark-800 dark:border-gray-700 shadow-2xl border dark:bg-gray-800 bg-white dark:bg-dark-900 flex relative\">\n                                    <button class=\"inline-flex text-gray-400 dark:text-gray-500 focus:outline-none focus:text-gray-500 transition ease-in-out duration-150 absolute right-0 top-0 mt-3 mr-3 close-notification\">\n                                        <svg class=\"h-5 w-5\" viewBox=\"0 0 20 20\" fill=\"currentColor\">\n                                            <path fill-rule=\"evenodd\" d=\"M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z\" clip-rule=\"evenodd\"></path>\n                                        </svg>\n                                    </button>\n                                    <div class=\"w-16 flex items-center rounded-tl-lg relative h-16 dark:bg-gray-700 bg-gray-50 p-2 border-r dark:border-gray-900 border-gray-200\">\n                                        <div class=\"w-auto rounded-full pl-1 relative\">\n                                            " + notificationSVG + "\n                                        </div>\n                                    </div>\n                                    <div class=\"w-full ml-5 mt-2 mb-3\">\n                                        <h4 class=\"" + notificationColor + " font-bold\">" + notificationTitle + "</h4>\n                                        <p class=\"text-xs text-gray-600 dark:text-gray-300 pr-8\">" + message + "</p>\n                                    </div>\n                                </div>";
...
for (var i = 0; i < trigger.length; i++) {
  ...
  trigger[i].addEventListener('click', function () {
    ...
    var picker = new _joeattardi_emoji_button__WEBPACK_IMPORTED_MODULE_2__["EmojiButton"]();
...
module.exports = __webpack_require__(/*! /Users/tonylea/Sites/guild/resources/sass/app.scss */"./resources/sass/app.scss");
