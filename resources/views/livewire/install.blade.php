<div  x-data="{ step: @entangle('step') }">
    ...
    <section x-show="step==0"
        ...
        <div  class="flex flex-col items-start mx-auto space-y-6 max-w-7xl">
            ...
            <p class="text-lg text-gray-500">Let's configure a few things and get your guild setup. This will only take 30 seconds.</p>
    ...
    <section x-show="step==1"
        ...
        <div  class="flex flex-col items-start mx-auto space-y-6 max-w-7xl">
            ...
            <p class="text-lg text-gray-500">First, enter a little information about your awesome company.</p>
