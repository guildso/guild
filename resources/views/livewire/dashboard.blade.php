                ...
                <div class="flex flex-col">
                    <form wire:submit.prevent="store()" class="relative flex items-center p-5 space-x-4 lg:space-x-2">
                        <a href="#_" class="relative flex-shrink-0 w-10 h-10 lg:w-12 lg:h-12">
                            ...
                            <span class="absolute bottom-0 right-0 w-4 h-4 mb-0 mr-0 @if($shift) bg-purple-500 @else bg-gray-300 @endif border-2 border-white rounded-full"></span>
                        </a>
                    ...
                    <div class="flex justify-between items-center p-5 space-x-4 @if($shift){{ 'bg-purple-500' }}@else{{ 'bg-gray-200' }}@endif">
                        @if($shift)
